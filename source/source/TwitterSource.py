...
class TwitterSource(object):
    ...
    def __init__(self, source_word_str, content_dir,
        ...
        # Create a logger
        self.logger = logging.getLogger(u"TwitterSource")
    ...
    def set_source(self, max_n_pages=5, do_purge=False):
    ...
    def dump(self, pickle_file_name=None):
        """Dumps TwitterSource attributes pickle.
    ...
    def load(self, pickle_file_name=None):
        """Loads TwitterSource attributes pickle.
