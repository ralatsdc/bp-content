...
"""
http://stackoverflow.com/questions/8554035/remove-all-javascript-tags-and-style-tags-from-html-with-python-and-the-lxml-mod
...
allow_tags = set(
    ['a', 'b', 'blockquote', 'body', 'div', 'em', 'h1', 'h2', 'h3',
    'h4', 'h5', 'h6', 'html', 'i', 'img', 'li', 'ol', 'p', 'q',
    'span', 'strong', 'table', 'tbody', 'td', 'th', 'time', 'tr', 'u',
    'ul'])

cleaner = Cleaner(style=True, remove_unknown_tags=False, allow_tags=allow_tags)
...
for author in inp_data['authors']:
    ...
    for entry in feed_author.entries:
        if 'value' in entry['content'][0]:
            ...
            print clean_html
            print
            tree = etree.parse(StringIO(clean_html), parser)
            root = tree.getroot()
